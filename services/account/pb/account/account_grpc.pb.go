...
const (
	Account_Signup_FullMethodName = "/account.Account/Signup"
	Account_Signin_FullMethodName = "/account.Account/Signin"
)
...
func (c *accountClient) Signin(ctx context.Context, in *SigninRequest, opts ...grpc.CallOption) (*SigninReply, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(SigninReply)
	err := c.cc.Invoke(ctx, Account_Signin_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
